...
Rectangle {
    ...
    Image {
        id: backgroundImage
        x: 16; y: 16; width: 874; height: 437
        source: "../images/lower_bckg.jpg"
    ...
    Image {
        ...
        // Bottom edge tiling
        x: 26; y: 438; width: 844; height: 19
        source: "../images/lower_bckg.jpg"
        fillMode: Image.TileHorizontally 
    }
    ...
    Image {
        ...
        // Right edge tiling
        x: 876; y: 24; width: 18; height: 410
        source: "../images/lower_bckg.jpg"
        fillMode: Image.TileVertically 
    }
    ...
    Rectangle {
        id: topRightCircle
        x: 855; y: 2; width: 40; height: 40; radius: 35
        rotation: 135
        gradient: Gradient {
            GradientStop { position: 0; color: "#000000" }
            GradientStop { position: 0.25; color: "#050505" }
    ...
    Rectangle {
        id: bottomLeftCircle
        x: 3; y: 417; width: 40; height: 40; radius: 35
        rotation: 315
        gradient: Gradient {
            GradientStop { position: 0; color: "#000000" }
            GradientStop { position: 0.25; color: "#050505" }
    ...
    Rectangle {
        ...
        x: 856; y: 417; width: 40; height: 40; radius: 35
        rotation: 225
        gradient: Gradient {
            GradientStop { position: 0; color: "#000000" }
            GradientStop { position: 0.25; color: "#050505" }
